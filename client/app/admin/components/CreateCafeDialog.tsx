...
export function CreateCafeDialog({ onCafeCreated }: CreateCafeDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert("Cafe Owner created successfully!");
        } catch (error) {
            if (axios.isAxiosError(error) && error.response) {
                alert(error.response.data.message || "Failed to create cafe owner");
            } else {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a new cafe owner account. They will be able to log in and manage their cafe using these credentials.
                    </DialogDescription>
                </DialogHeader>
