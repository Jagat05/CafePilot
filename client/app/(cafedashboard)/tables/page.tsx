...
export default function TablesPage() {
    ...
    const handleCreateOrder = (orderData: { items: { menuItemId: string; quantity: number }[]; customerName: string }) => {
                ...
                {tables.map((table) => (
                    <div key={table.id} className="relative group">
                        ...
                        >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3"><path d="M18 6 6 18" /><path d="m6 6 18 18" /></svg>
                        </Button>
                    </div>
                ))}
            </div>
